...
const Footer = () => {
  return (
        <div className="bg-bkgBlack pt-20 pb-16  ">
            <div className="mx-auto max-w-7xl px-6 grid grid-cols-4  gap-x-5 md:grid-cols-8  lg:grid-cols-12 ">
                <div className=" col-span-4 md:row-span-2 mb-14">
                    <h4 className="text-softBlue text-left uppercase font-heading font-extrabold text-3xl">
                        IMAGINE A PLACE
                    </h4>
                    <div className="mt-5 flex items-center cursor-pointer">
                        <img className="h-4 mr-2" src={USFlag} alt="flag"/>
                ...
                {Links.map((linkdata , index) => 
                    (
                        <div className=" col-span-2 text-left self-start mb-10" key={index}>
                            <h5 className="text-softBlue pt-2">{linkdata.category}</h5>
                            {linkdata.link.map((item,currIndex,) => (
            ...
            <div className="px-6 mx-auto max-w-7xl ">
                <div className="h-[1px] bg-softBlue mb-8"></div>
                <div className="flex items-center justify-between">
                    <a href="https://discord.com/">
                        <img src={Logo} alt="Discord" />
                    </a>
                    <Link to="/register">
                        <div className="bg-softBlue text-white rounded-3xl px-4 py-2 text-sm hover:bg-[#7289da] hover:shadow-md hover:shadow-black/25 cursor-pointer">
                            Sign up
                        </div>
                    </Link>
                </div>
